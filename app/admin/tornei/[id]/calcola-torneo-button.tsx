...
import { calcolaPunteggiTorneoAction } from "@/lib/actions/admin";

export function CalcolaPunteggiTorneoButton({ tournamentId }: { tournamentId: string }) {
      ...
      <button
        ...
        onClick={() =>
          startTransition(async () => {
            const res = await calcolaPunteggiTorneoAction(tournamentId);
