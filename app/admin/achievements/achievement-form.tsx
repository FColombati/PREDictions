      ...
      <div className="panel-cut grid gap-4 p-6 sm:grid-cols-2">
        ...
        <div>
          ...
          >
            ...
            <option value="LOSE_STREAK_UPDATED">Streak di sconfitte aggiornata</option>
            <option value="PUNTEGGIO_SCHEDINA_ALTO">Punteggio alto in una schedina</option>
            <option value="SCHEDINA_FALLITA_TOTALE">Schedina fallita completamente</option>
            <option value="PUNTI_TOTALI_CARRIERA">Punti totali accumulati</option>
