        ...
        {haEsempio && (
          <div>
            <label className="mb-1.5 block text-sm text-text-muted">
              CSS avanzato (opzionale — es. <code>@keyframes</code> per le animazioni, oppure <code>@media</code> per un trattamento diverso su mobile)
            </label>
            <textarea
              name="cssAvanzato"
              value={cssAvanzato}
