  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
      <div className="mb-2 flex flex-wrap items-center gap-2 text-xs text-text-muted">
        <span>Classe CSS per override responsive:</span>
        <code className="rounded bg-panel-2 px-2 py-1 font-mono text-signal">.cosmetic-{reward.id}.cosmetic-{reward.id}</code>
      </div>
