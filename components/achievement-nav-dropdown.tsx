...
export function AchievementNavDropdown() {
  ...
  const attivo = VOCI.some((v) => pathname === v.href || pathname.startsWith(`${v.href}/`));
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="relative flex items-center gap-1 pb-1 text-sm text-text-muted transition-colors hover:text-text"
      >
        Achievement
